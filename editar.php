...
<section >	
      ...
      <div class="row">
        <div class="col-xs-2"></div>
          <div class="col-xs-8">   
            <form class="app-abajo app-arriba" action="editar_db.php" name="registro" method="POST">
              <ul class="list-group">
                    ...
                    <li class="list-group-item">
                      ...
                      <input type="time" name="hora" class="app-input form-control">
                    </li>                
                    <!--tabla dependencia -->
                    <li class="list-group-item">
                   ...
                   <!-- Entregado a -->
                    ...
                    <li class="list-group-item">
                      ...
                      <input type="time" class="app-input form-control" name="hora_E">                    
                    </li>
                    <!-- indice de archivo -->
                    <li class="list-group-item">
                    ...
                    <li class="list-group-item">
                      <div class="row">
                        ...
                        <button class="btn btn-primary app-btn1 btn-block" onclick="alert('Editando Memo')"><span class="glyphicon glyphicon-edit "></span> Editar</button>
                        </div>
                        <div class="col-xs-12 col-sm-4"></div>
                      </div>
                    </li>
